...
// optional helmet for basic hardening if installed
try {
  const helmet = require('helmet')
  app.use(helmet())
} catch (e) {
  console.warn('helmet not installed — skipping basic hardening middleware')
}

// discovery route
const { discoverRestaurants } = require('./services/restaurantDiscovery')
const fs = require('fs')
