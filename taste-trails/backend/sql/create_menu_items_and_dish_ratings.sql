...
CREATE TABLE IF NOT EXISTS menu_items (
    ...
    is_shellfish_free boolean NOT NULL DEFAULT false,
    is_egg_free boolean NOT NULL DEFAULT false,
    is_keto boolean NOT NULL DEFAULT false,
    is_paleo boolean NOT NULL DEFAULT false,
    is_halal boolean NOT NULL DEFAULT false,
    is_kosher boolean NOT NULL DEFAULT false,
    dietary_confidence_score float DEFAULT 0,
    dietary_manual_override boolean NOT NULL DEFAULT false,
