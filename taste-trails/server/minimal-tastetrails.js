...
let supabase = null;
if (!SUPABASE_URL) {
	console.warn('[Supabase] SUPABASE_URL is missing. Supabase client will not be initialized.');
} else if (!SUPABASE_SERVICE_KEY && !SUPABASE_KEY) {
	console.warn('[Supabase] SUPABASE_SERVICE_KEY and SUPABASE_KEY are missing. Supabase client will not be initialized.');
} else {
